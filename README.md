                  ...
                  <ul>
                    <li class="active-img">
                      <div class="slide-caption">
                        <h6>Collections</h6>
                        <h2>Precious<br>Treasures</h2>
                      </div>
                    </li>
                    <li>
                      <div class="slide-caption">
                        <h6>Vision</h6>
                        <h2>360° 3D<br>Holographic</h2>
                      </div>
                    </li>
                    <li>
                      <div class="slide-caption">
                        <h6>Guide</h6>
                        <h2>Self-help<br>Chat</h2>
                      </div>
                    </li>
                  </ul>
                </div>
            ...
            <div class="content second-content">
                <div id='tabs'>
                  ...
                  <section class='tabs-content'>
                    <article id='tabs-1'>
                      <h2>What We Offer?</h2>
                      <span>Huge numbers of collections</span>
                      <p>More than 25million collections in our museum, include pinned objects, paper objects assemblages,liquids,tissue samples etc...</p>
                      <p>Mummies, Dinosaur bones,everything we have that you can think of</p>
                    </article>
                    <article id='tabs-2'>
                      <h2>What We Provide?</h2>
                      <span>Holographic projection</span>
                      <p>Our new 3D imaging technology allows you to view collections from all angles anytime, anywhere</p>
                      <p>For some special exhibits, we provide holographic projections, which can make you experience as if you were there</p>
                    </article>
                    <article id='tabs-3'>
                      <h2>How to join us?</h2>
                      <span>Visit our website on PC or smart phone</span>
                      <p>We provide mobile and computer websites for you to visit our digital museum anytime, anywhere</p>
                      <p>We recommended to use a larger display device for a better experience to use our online service</p>
                    </article>
                  </section>
                </div>
            </div>
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="col-md-12">
                                <div class="featured-item">
                                    ...
                                    <div class="down-content">
                                        <h4>Lifetime Membership-Guide</h4>
                                        <h6>$998.00</h6>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="content fourth-content">
                <div class="container-fluid">
                    <form id="contact" action="" method="post">
                        <div class="row">
                          <div class="col-md-12">
                            <h2>Say Hello to World Museum!</h2>
                          </div>
                          <div class="col-md-6">
                            <fieldset>
